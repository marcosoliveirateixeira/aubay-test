...
resource "google_compute_instance_iam_binding" "vm-iam-binding" {
  instance_name = google_compute_instance.instance-1.name
  zone = google_compute_instance.instance-1.zone

  role = "roles/compute.instanceAdmin"

  members = [
    "user:paulomonteiro1976@outlook.com"
  ]
}